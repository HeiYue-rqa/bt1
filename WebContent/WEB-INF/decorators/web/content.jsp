        ...
        <% request.setAttribute("action", request.getParameter("home")); %>
            <c:choose>
                <c:when test="${action eq 'tuvan' }">
                    ...
                    <header class="py-5 bg-light border-bottom mb-4 special-bg">
                        <div class="container">
                            <div class="text-center my-5">
                                <h1 class="fw-bolder">Hỏi - đáp</h1>
                                <p class="lead mb-0">Chúng tôi luôn cố gắng tìm ra câu trả lời cho những thắc mắc của
                                    bạn</p>
                            </div>
                        </div>
                    </header>
                ...
                <c:otherwise>
                    <!-- Page header with logo and tagline-->
                    <header class="py-5 bg-light border-bottom special-bg">
                        <div class="container">
                            <div class="text-center my-5">
                                <h1 class="fw-bolder">Trang chủ</h1>
                                <p class="lead mb-0">Giới thiệu về ngành thuốc</p>
                            </div>
                        </div>
                    </header>
