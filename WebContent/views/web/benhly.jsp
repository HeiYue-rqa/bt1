...
<body>
	<!-- Blog entries-->
	<div class="col-lg-8">
		<form action="/trang-new" id="formBaiviet" name="formBaiviet"
			method="get">
			...
			<div class="card mb-4">
				<a href="#!"><img class="card-img-top"
					src="<c:if test="${empty maxNew.thumbnail}">
	<c:set var="thumbnail" value="https://dummyimage.com/850x350/dee2e6/6c757d.jpg"/>${thumbnail}
</c:if>
<c:if test="${not empty maxNew.thumbnail}"><c:out value = "${maxNew.thumbnail}"/></c:if>" alt="..." /></a>
				<div class="card-body">
			...
			<div class="row">
				...
				<c:if test="${item.id != maxNew.id}">
					<div class="col-lg-6">
						...
						<div class="card mb-4">
							<a href="#!"><img class="card-img-top"
								src="<c:if test="${empty item.thumbnail}">
	<c:set var="thumbnail" value="https://dummyimage.com/850x350/dee2e6/6c757d.jpg"/>
	<c:out value = "${thumbnail}"/>
</c:if>
<c:if test="${not empty item.thumbnail}"><c:out value = "${item.thumbnail}"/></c:if>
" alt="..." /></a>
							<div class="card-body">
